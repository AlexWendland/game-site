...
from render_backend.utils import GAME_NAME_LENGTH, _random_game_name, non_matching_game_name
...
def test_game_state_generates_non_conflicting_game():
    ...
    """
    with patch("render_backend.utils._random_game_name") as mock_new_game_name:
