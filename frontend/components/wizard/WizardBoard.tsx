...
export function WizardBoard() {
  ...
  function getPlayerCard(cardPosition: number): ReactNode {
    ...
    if (player === null || player === viewingPlayer) {
      return <div />;
    }
    return (
      <WizardPlayerCard
  ...
  return (
    <div className="grid grid-cols-5 gap-2 w-full max-w-[800px] justify-items-center">
      <div className="col-start-1 row-start-1">
        {
          // Trump card and suit (To improve)
        }
        <div className="grid grid-cols-2">
          ...
          <div className="col-start-2 grid grid-cols-1 justify-items-center">
            <div className="text-sm text-gray-500 text-center">Trump suit</div>
            <div>
              {" "}
              {trumpSuit !== null
                ? (trumpSuitNames.get(trumpSuit) ?? "No Trump")
                : "No Trump"}
            </div>
          </div>
        </div>
