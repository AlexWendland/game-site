            ...
            return (
              <button
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                  isSelected
                    ? "bg-yellow-400 dark:bg-yellow-800 text-gray-800 dark:text-gray-200 shadow-lg ring-2 ring-purple-300 dark:ring-purple-400 scale-110"
                    : isDisabledLevel
                      ? "bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-400 cursor-not-allowed opacity-40"
                      : "bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 hover:bg-purple-200 dark:hover:bg-purple-800 hover:text-purple-700 dark:hover:text-purple-300 cursor-pointer hover:scale-105"
                }`}
              >
                {icon}
              </button>
